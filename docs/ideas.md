...
### 1. Video Upload & Background Looping
...
### 2. Push History & 1-Click Rollback
...
### 4. Daypart Scheduling & Automated Playlists
...
### 5. Multi-Screen Fleet Management & Location Tagging
...
### 6. Multi-Screen Synchronization (Video Wall Clustering)
...
### 7. Live Menu (HTML/CSS & Hybrid Text Overlays)
