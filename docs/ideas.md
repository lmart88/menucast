...
### 1. Interactive Hero Demo & Video Walkthrough
* **Category**: Marketing Landing Page / Interactive Showcase
* **Impact**: Low-Medium — Provides an interactive sandbox/simulation or recorded video walkthrough on the marketing landing page hero.
* **Status**: `Parked for V2.0`
* **Notes**: The core responsive hero, theme toggle, and representative 16:9 menu demo already deliver the core value proposition and UX contract via [`docs/spec-homepage-ui-redesign.md`](file:///Users/battosai/Dev/menucast/docs/spec-homepage-ui-redesign.md); an interactive widget adds unnecessary client bundle weight for MVP launch.
...
### 3. Video Upload & Background Looping
...
### 4. Push History & 1-Click Rollback
...
### 6. Daypart Scheduling & Automated Playlists
...
### 7. Multi-Screen Fleet Management & Location Tagging
...
### 8. Multi-Screen Synchronization (Video Wall Clustering)
...
### 9. Live Menu (HTML/CSS & Hybrid Text Overlays)
